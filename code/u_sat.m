...
% ======================== Description ======================== %
%                                                               %
%   Purpose : Apply actuator saturation, respecting thrust and  %
%             torque limits derived from geometry and inertia.  %
%                                                               %
%   Input   : K_err  - Control error vector                     %
%             L      - Lever arm length                         %
%             J_zz   - Yaw-axis inertia                         %
%             T_max  - Maximum thrust                           %
%                                                               %
%   Output  : U_out  - Saturated control command vector         %
%                                                               %
% ========================== Content ========================== %
